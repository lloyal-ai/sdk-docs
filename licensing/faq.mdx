...
The `lloyal-ai` CLI and `hdk-create-app` scaffolder are licensed under
...
| **`@lloyal-labs/harness-cli` (the `lloyal-ai` CLI)** | **Apache 2.0** | Scaffolder — unrestricted for scaffolding new harnesses and Apps |
